...
sys_exofork(void)
{
  ...
  8000e2:	89 c6                	mov    %eax,%esi
	...
	cprintf("envid: %x\n", envid);
  8000e4:	50                   	push   %eax
  8000e5:	68 a7 11 80 00       	push   $0x8011a7
  ...
  8000f6:	53                   	push   %ebx
  8000f7:	68 b2 11 80 00       	push   $0x8011b2
  8000fc:	6a 3a                	push   $0x3a
  8000fe:	68 73 11 80 00       	push   $0x801173
  ...
  80012d:	68 c2 11 80 00       	push   $0x8011c2
  ...
  800186:	50                   	push   %eax
  800187:	68 ca 11 80 00       	push   $0x8011ca
  80018c:	6a 50                	push   $0x50
  80018e:	68 73 11 80 00       	push   $0x801173
...
umain(int argc, char **argv)
{
  ...
  8001b4:	50                   	push   %eax
  8001b5:	68 e1 11 80 00       	push   $0x8011e1
  8001ba:	e8 7c 01 00 00       	call   80033b <cprintf>
  8001bf:	83 c4 10             	add    $0x10,%esp
  8001c2:	85 f6                	test   %esi,%esi
  8001c4:	bf f6 11 80 00       	mov    $0x8011f6,%edi
  8001c9:	b8 ef 11 80 00       	mov    $0x8011ef,%eax
  ...
  8001db:	57                   	push   %edi
  8001dc:	53                   	push   %ebx
  8001dd:	68 fc 11 80 00       	push   $0x8011fc
...
libmain(int argc, char **argv)
{
  ...
  80021f:	6b c0 7c             	imul   $0x7c,%eax,%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80027e:	56                   	push   %esi
  80027f:	50                   	push   %eax
  800280:	68 18 12 80 00       	push   $0x801218
  ...
  800291:	e8 54 00 00 00       	call   8002ea <vcprintf>
	cprintf("\n");
  800296:	c7 04 24 0c 12 80 00 	movl   $0x80120c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80039e:	e8 1d 0b 00 00       	call   800ec0 <__udivdi3>
  ...
  8003e1:	e8 0a 0c 00 00       	call   800ff0 <__umoddi3>
  8003e6:	83 c4 14             	add    $0x14,%esp
  8003e9:	0f be 80 3c 12 80 00 	movsbl 0x80123c(%eax),%eax
  8003f0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004f0:	ff 24 85 00 13 80 00 	jmp    *0x801300(,%eax,4)
  ...
  8005b4:	8b 14 85 60 14 80 00 	mov    0x801460(,%eax,4),%edx
  8005bb:	85 d2                	test   %edx,%edx
  8005bd:	75 18                	jne    8005d7 <vprintfmt+0x165>
				printfmt(putch, putdat, "error %d", err);
  8005bf:	50                   	push   %eax
  8005c0:	68 54 12 80 00       	push   $0x801254
  8005c5:	53                   	push   %ebx
  8005c6:	56                   	push   %esi
  ...
  8005d7:	52                   	push   %edx
  8005d8:	68 5d 12 80 00       	push   $0x80125d
  8005dd:	53                   	push   %ebx
  8005de:	56                   	push   %esi
  ...
  8005fc:	b8 4d 12 80 00       	mov    $0x80124d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800cb2:	68 84 14 80 00       	push   $0x801484
  800cb7:	6a 23                	push   $0x23
  800cb9:	68 a1 14 80 00       	push   $0x8014a1
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d33:	68 84 14 80 00       	push   $0x801484
  800d38:	6a 23                	push   $0x23
  800d3a:	68 a1 14 80 00       	push   $0x8014a1
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800d75:	68 84 14 80 00       	push   $0x801484
  800d7a:	6a 23                	push   $0x23
  800d7c:	68 a1 14 80 00       	push   $0x8014a1
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800db7:	68 84 14 80 00       	push   $0x801484
  800dbc:	6a 23                	push   $0x23
  800dbe:	68 a1 14 80 00       	push   $0x8014a1
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800df9:	68 84 14 80 00       	push   $0x801484
  800dfe:	6a 23                	push   $0x23
  800e00:	68 a1 14 80 00       	push   $0x8014a1
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800e3b:	68 84 14 80 00       	push   $0x801484
  800e40:	6a 23                	push   $0x23
  800e42:	68 a1 14 80 00       	push   $0x8014a1
...
sys_ipc_recv(void *dstva)
{
  ...
  800e9f:	68 84 14 80 00       	push   $0x801484
  800ea4:	6a 23                	push   $0x23
  800ea6:	68 a1 14 80 00       	push   $0x8014a1
