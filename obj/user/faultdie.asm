...
umain(int argc, char **argv)
{
  ...
  80006c:	e8 77 0c 00 00       	call   800ce8 <set_pgfault_handler>
	*(int*)0xDeadBeef = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	e8 fd 0b 00 00       	call   800dd0 <__udivdi3>
  ...
  800211:	e8 ea 0c 00 00       	call   800f00 <__umoddi3>
  800216:	83 c4 14             	add    $0x14,%esp
  800219:	0f be 80 86 10 80 00 	movsbl 0x801086(%eax),%eax
  800220:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800320:	ff 24 85 40 11 80 00 	jmp    *0x801140(,%eax,4)
  ...
  8003e4:	8b 14 85 a0 12 80 00 	mov    0x8012a0(,%eax,4),%edx
  8003eb:	85 d2                	test   %edx,%edx
  8003ed:	75 18                	jne    800407 <vprintfmt+0x165>
				printfmt(putch, putdat, "error %d", err);
  8003ef:	50                   	push   %eax
  8003f0:	68 9e 10 80 00       	push   $0x80109e
  8003f5:	53                   	push   %ebx
  8003f6:	56                   	push   %esi
  ...
  800407:	52                   	push   %edx
  800408:	68 a7 10 80 00       	push   $0x8010a7
  80040d:	53                   	push   %ebx
  80040e:	56                   	push   %esi
  ...
  80042c:	b8 97 10 80 00       	mov    $0x801097,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ae2:	68 c4 12 80 00       	push   $0x8012c4
  800ae7:	6a 23                	push   $0x23
  800ae9:	68 e1 12 80 00       	push   $0x8012e1
  800aee:	e8 88 02 00 00       	call   800d7b <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b63:	68 c4 12 80 00       	push   $0x8012c4
  800b68:	6a 23                	push   $0x23
  800b6a:	68 e1 12 80 00       	push   $0x8012e1
  800b6f:	e8 07 02 00 00       	call   800d7b <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ba5:	68 c4 12 80 00       	push   $0x8012c4
  800baa:	6a 23                	push   $0x23
  800bac:	68 e1 12 80 00       	push   $0x8012e1
  800bb1:	e8 c5 01 00 00       	call   800d7b <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800be7:	68 c4 12 80 00       	push   $0x8012c4
  800bec:	6a 23                	push   $0x23
  800bee:	68 e1 12 80 00       	push   $0x8012e1
  800bf3:	e8 83 01 00 00       	call   800d7b <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c29:	68 c4 12 80 00       	push   $0x8012c4
  800c2e:	6a 23                	push   $0x23
  800c30:	68 e1 12 80 00       	push   $0x8012e1
  800c35:	e8 41 01 00 00       	call   800d7b <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c6b:	68 c4 12 80 00       	push   $0x8012c4
  800c70:	6a 23                	push   $0x23
  800c72:	68 e1 12 80 00       	push   $0x8012e1
  800c77:	e8 ff 00 00 00       	call   800d7b <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800ccf:	68 c4 12 80 00       	push   $0x8012c4
  800cd4:	6a 23                	push   $0x23
  800cd6:	68 e1 12 80 00       	push   $0x8012e1
  800cdb:	e8 9b 00 00 00       	call   800d7b <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800cee:	83 3d 0c 20 80 00 00 	cmpl   $0x0,0x80200c
  ...
  800d03:	e8 31 fe ff ff       	call   800b39 <sys_page_alloc>
  800d08:	83 c4 10             	add    $0x10,%esp
  800d0b:	85 c0                	test   %eax,%eax
  800d0d:	79 14                	jns    800d23 <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler:sys_page_alloc failed");;
  800d0f:	83 ec 04             	sub    $0x4,%esp
  800d12:	68 f0 12 80 00       	push   $0x8012f0
  800d17:	6a 21                	push   $0x21
  800d19:	68 52 13 80 00       	push   $0x801352
  800d1e:	e8 58 00 00 00       	call   800d7b <_panic>
	}
	// Save handler pointer for assembly to call.
	_pgfault_handler = handler;
  800d23:	8b 45 08             	mov    0x8(%ebp),%eax
  800d26:	a3 0c 20 80 00       	mov    %eax,0x80200c
	if (sys_env_set_pgfault_upcall(0, _pgfault_upcall) < 0)
  800d2b:	83 ec 08             	sub    $0x8,%esp
  800d2e:	68 57 0d 80 00       	push   $0x800d57
  800d33:	6a 00                	push   $0x0
  800d35:	e8 08 ff ff ff       	call   800c42 <sys_env_set_pgfault_upcall>
  800d3a:	83 c4 10             	add    $0x10,%esp
  800d3d:	85 c0                	test   %eax,%eax
  800d3f:	79 14                	jns    800d55 <set_pgfault_handler+0x6d>
		panic("set_pgfault_handler:sys_env_set_pgfault_upcall failed");
  800d41:	83 ec 04             	sub    $0x4,%esp
  800d44:	68 1c 13 80 00       	push   $0x80131c
  800d49:	6a 26                	push   $0x26
  800d4b:	68 52 13 80 00       	push   $0x801352
  800d50:	e8 26 00 00 00       	call   800d7b <_panic>
}
  800d55:	c9                   	leave  
  800d56:	c3                   	ret    

00800d57 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800d58:	a1 0c 20 80 00       	mov    0x80200c,%eax
	call *%eax
  800d5d:	ff d0                	call   *%eax
	addl $4, %esp			// pop function argument
  800d5f:	83 c4 04             	add    $0x4,%esp
  ...
  800d62:	8b 54 24 28          	mov    0x28(%esp),%edx
	subl $0x4, 0x30(%esp)
  800d66:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
	movl 0x30(%esp), %eax #trap-time esp-4
  800d6b:	8b 44 24 30          	mov    0x30(%esp),%eax
	movl %edx, (%eax)
  800d6f:	89 10                	mov    %edx,(%eax)
	addl $0x8, %esp
  800d71:	83 c4 08             	add    $0x8,%esp
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d89:	e8 6d fd ff ff       	call   800afb <sys_getenvid>
  800d8e:	83 ec 0c             	sub    $0xc,%esp
  800d91:	ff 75 0c             	pushl  0xc(%ebp)
  800d94:	ff 75 08             	pushl  0x8(%ebp)
  800d97:	56                   	push   %esi
  800d98:	50                   	push   %eax
  800d99:	68 60 13 80 00       	push   $0x801360
  800d9e:	e8 c8 f3 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800da3:	83 c4 18             	add    $0x18,%esp
  800da6:	53                   	push   %ebx
  800da7:	ff 75 10             	pushl  0x10(%ebp)
  800daa:	e8 6b f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800daf:	c7 04 24 7a 10 80 00 	movl   $0x80107a,(%esp)
  800db6:	e8 b0 f3 ff ff       	call   80016b <cprintf>
