...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003bd:	50                   	push   %eax
  8003be:	68 e0 0f 80 00       	push   $0x800fe0
  8003c3:	53                   	push   %ebx
  8003c4:	56                   	push   %esi
  ...
  8003d5:	52                   	push   %edx
  8003d6:	68 e9 0f 80 00       	push   $0x800fe9
  8003db:	53                   	push   %ebx
  8003dc:	56                   	push   %esi
  ...
  8003fa:	b8 d9 0f 80 00       	mov    $0x800fd9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ab0:	68 04 12 80 00       	push   $0x801204
  800ab5:	6a 23                	push   $0x23
  800ab7:	68 21 12 80 00       	push   $0x801221
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b31:	68 04 12 80 00       	push   $0x801204
  800b36:	6a 23                	push   $0x23
  800b38:	68 21 12 80 00       	push   $0x801221
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b73:	68 04 12 80 00       	push   $0x801204
  800b78:	6a 23                	push   $0x23
  800b7a:	68 21 12 80 00       	push   $0x801221
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bb5:	68 04 12 80 00       	push   $0x801204
  800bba:	6a 23                	push   $0x23
  800bbc:	68 21 12 80 00       	push   $0x801221
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800bf7:	68 04 12 80 00       	push   $0x801204
  800bfc:	6a 23                	push   $0x23
  800bfe:	68 21 12 80 00       	push   $0x801221
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c39:	68 04 12 80 00       	push   $0x801204
  800c3e:	6a 23                	push   $0x23
  800c40:	68 21 12 80 00       	push   $0x801221
...
sys_ipc_recv(void *dstva)
{
  ...
  800c9d:	68 04 12 80 00       	push   $0x801204
  800ca2:	6a 23                	push   $0x23
  800ca4:	68 21 12 80 00       	push   $0x801221
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800cd2:	56                   	push   %esi
  800cd3:	50                   	push   %eax
  800cd4:	68 30 12 80 00       	push   $0x801230
  ...
  800ce5:	e8 fe f3 ff ff       	call   8000e8 <vcprintf>
	cprintf("\n");
  800cea:	c7 04 24 bc 0f 80 00 	movl   $0x800fbc,(%esp)
