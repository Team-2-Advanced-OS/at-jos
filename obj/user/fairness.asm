...
umain(int argc, char **argv)
{
  ...
  800058:	56                   	push   %esi
  800059:	e8 ab 0c 00 00       	call   800d09 <ipc_recv>
  ...
  800096:	50                   	push   %eax
  800097:	e8 d4 0c 00 00       	call   800d70 <ipc_send>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800341:	ff 24 85 c0 11 80 00 	jmp    *0x8011c0(,%eax,4)
  ...
  800405:	8b 14 85 20 13 80 00 	mov    0x801320(,%eax,4),%edx
  80040c:	85 d2                	test   %edx,%edx
  80040e:	75 18                	jne    800428 <vprintfmt+0x165>
				printfmt(putch, putdat, "error %d", err);
  800410:	50                   	push   %eax
  800411:	68 0a 11 80 00       	push   $0x80110a
  800416:	53                   	push   %ebx
  800417:	56                   	push   %esi
  ...
  80044d:	b8 03 11 80 00       	mov    $0x801103,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b03:	68 44 13 80 00       	push   $0x801344
  800b08:	6a 23                	push   $0x23
  800b0a:	68 61 13 80 00       	push   $0x801361
  800b0f:	e8 bc 02 00 00       	call   800dd0 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b90:	e8 3b 02 00 00       	call   800dd0 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bc6:	68 44 13 80 00       	push   $0x801344
  800bcb:	6a 23                	push   $0x23
  800bcd:	68 61 13 80 00       	push   $0x801361
  800bd2:	e8 f9 01 00 00       	call   800dd0 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c08:	68 44 13 80 00       	push   $0x801344
  800c0d:	6a 23                	push   $0x23
  800c0f:	68 61 13 80 00       	push   $0x801361
  800c14:	e8 b7 01 00 00       	call   800dd0 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c4a:	68 44 13 80 00       	push   $0x801344
  800c4f:	6a 23                	push   $0x23
  800c51:	68 61 13 80 00       	push   $0x801361
  800c56:	e8 75 01 00 00       	call   800dd0 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c8c:	68 44 13 80 00       	push   $0x801344
  800c91:	6a 23                	push   $0x23
  800c93:	68 61 13 80 00       	push   $0x801361
  800c98:	e8 33 01 00 00       	call   800dd0 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf0:	68 44 13 80 00       	push   $0x801344
  800cf5:	6a 23                	push   $0x23
  800cf7:	68 61 13 80 00       	push   $0x801361
  800cfc:	e8 cf 00 00 00       	call   800dd0 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d19:	74 06                	je     800d21 <ipc_recv+0x18>
  800d1b:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
	if (perm_store) *perm_store = 0;
  800d21:	85 db                	test   %ebx,%ebx
  800d23:	74 06                	je     800d2b <ipc_recv+0x22>
  800d25:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	if (!pg) pg = (void*) -1;
  800d2b:	85 c0                	test   %eax,%eax
  800d2d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800d32:	0f 44 c2             	cmove  %edx,%eax
	int ret = sys_ipc_recv(pg);
  800d35:	83 ec 0c             	sub    $0xc,%esp
  800d38:	50                   	push   %eax
  800d39:	e8 8a ff ff ff       	call   800cc8 <sys_ipc_recv>
	if (ret) return ret;
  800d3e:	83 c4 10             	add    $0x10,%esp
  800d41:	85 c0                	test   %eax,%eax
  800d43:	75 24                	jne    800d69 <ipc_recv+0x60>
	if (from_env_store)
  800d45:	85 f6                	test   %esi,%esi
  800d47:	74 0a                	je     800d53 <ipc_recv+0x4a>
		*from_env_store = thisenv->env_ipc_from;
  800d49:	a1 04 20 80 00       	mov    0x802004,%eax
  800d4e:	8b 40 74             	mov    0x74(%eax),%eax
  800d51:	89 06                	mov    %eax,(%esi)
	if (perm_store)
  800d53:	85 db                	test   %ebx,%ebx
  800d55:	74 0a                	je     800d61 <ipc_recv+0x58>
		*perm_store = thisenv->env_ipc_perm;
  800d57:	a1 04 20 80 00       	mov    0x802004,%eax
  800d5c:	8b 40 78             	mov    0x78(%eax),%eax
  800d5f:	89 03                	mov    %eax,(%ebx)
	return thisenv->env_ipc_value;
  800d61:	a1 04 20 80 00       	mov    0x802004,%eax
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d7b:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  800d80:	0f 44 c2             	cmove  %edx,%eax
	int success = sys_ipc_try_send(to_env, val, pg, perm) ;
  800d83:	ff 75 14             	pushl  0x14(%ebp)
  800d86:	50                   	push   %eax
  800d87:	ff 75 0c             	pushl  0xc(%ebp)
  800d8a:	ff 75 08             	pushl  0x8(%ebp)
  800d8d:	e8 13 ff ff ff       	call   800ca5 <sys_ipc_try_send>
		if (success == 0) break;
...
ipc_find_env(enum EnvType type)
{
  ...
  800da2:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800da5:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800dab:	8b 52 50             	mov    0x50(%edx),%edx
  800dae:	39 ca                	cmp    %ecx,%edx
  800db0:	75 0d                	jne    800dbf <ipc_find_env+0x28>
			return envs[i].env_id;
  800db2:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800db5:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800dba:	8b 40 48             	mov    0x48(%eax),%eax
  800dbd:	eb 0f                	jmp    800dce <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800dc2:	3d 00 04 00 00       	cmp    $0x400,%eax
  800dc7:	75 d9                	jne    800da2 <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dde:	e8 39 fd ff ff       	call   800b1c <sys_getenvid>
  800de3:	83 ec 0c             	sub    $0xc,%esp
  800de6:	ff 75 0c             	pushl  0xc(%ebp)
  800de9:	ff 75 08             	pushl  0x8(%ebp)
  800dec:	56                   	push   %esi
  800ded:	50                   	push   %eax
  800dee:	68 70 13 80 00       	push   $0x801370
  800df3:	e8 94 f3 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800df8:	83 c4 18             	add    $0x18,%esp
  800dfb:	53                   	push   %ebx
  800dfc:	ff 75 10             	pushl  0x10(%ebp)
  800dff:	e8 37 f3 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800e04:	c7 04 24 cf 10 80 00 	movl   $0x8010cf,(%esp)
  800e0b:	e8 7c f3 ff ff       	call   80018c <cprintf>
